...
public abstract class AbstractOrderItemRequest {
    ...
    protected void copyProperties(AbstractOrderItemRequest newRequest) {
        ...
        newRequest.setSTART_DATE(START_DATE);
	...
	public String toString() {
		return "AbstractOrderItemRequest [sku=" + sku + ", category=" + category + ", product=" + product + ", order="
				+ order + ", quantity=" + quantity + ", START_DATE=" + START_DATE + ", salePriceOverride="
				+ salePriceOverride + ", retailPriceOverride=" + retailPriceOverride + ", personalMessage="
				+ personalMessage + ", itemAttributes=" + itemAttributes + "]";
	}
